...
const CONTAIN_MODES: ("contain" | "cover" | "stretch")[] = ["contain", "cover", "stretch"];export default function PlayerScreen() {
  ...
  const fillPct = isLive ? 0 : (progress.current / progress.duration) * 100;return (
